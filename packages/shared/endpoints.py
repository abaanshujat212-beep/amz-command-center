...
ENDPOINTS: dict[str, Endpoint] = dict(
    [
        ...
        _e("ads.targets.list", Api.ADS, "POST", "/sp/targets/list", "List product and auto targets with current bids.", scope="advertising::campaign_management", notes="Targets are distinct Ads entities and must never be read through the keyword endpoint."),
